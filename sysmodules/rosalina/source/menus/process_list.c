...
#define TRY(expr) if(R_FAILED(res = (expr))) goto end;
    ...
    const char * wait_message = "Por favor espera, esto puede demorar un rato...";
    ...
    do
    {
        ...
        Draw_DrawString(10, 30+SPACING_Y, COLOR_WHITE, "Pulsa [B] para salir.");
        ...
        if(codeAvailable || heapAvailable)
        {
            ...
            void drawMenu(void)
            {
                ...
                if(codeAvailable && heapAvailable)
                {
                    ...
                    viewerY += SPACING_Y;
                    Draw_DrawString(10, infoY, COLOR_WHITE, "Pulsar L o R para alternar entre heap and code.");
